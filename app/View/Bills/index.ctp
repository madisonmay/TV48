...
<?php echo $this->Form->create(); ?>
    <fieldset>
        ...
        <?php 
        	$electricity_cost = array('class' => 'span3', 'label' => '', 'placeholder' => 'Electricity cost...', 'type' => 'text');
        	echo $this->Form->input('electricity_cost', $electricity_cost);
        	$heating_cost = array('class' => 'span3', 'label' => '', 'placeholder' => 'Heating cost...', 'type' => 'text');
        	echo $this->Form->input('heating_cost', $heating_cost);
            $start_date = array('class' => 'span3', 'label' => '', 'placeholder' => 'Start date...');
