...
sorttable = {
  ...
  reverse: function(tbody) {
    ...
    for (var i=0; i<tbody.rows.length; i++) {
      if ($(tbody.rows[i]).hasClass('deactivated')) {
        subrow_inactive[subrow_inactive.length] = tbody.rows[i]; 
      } else {
        subrow_active[subrow_active.length] = tbody.rows[i];  
      }
    }
    var newrows = subrow_inactive.concat(subrow_active);
  ...
  sort_numeric: function(a,b) {
    var a1 = $(a[1]).hasClass("deactivated");
