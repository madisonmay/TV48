...
<body>
    ...
    <form style='text-align: center;' action='submitLight.php' method='POST'>
        <input type='text' class='centered' style='display: block;' name='name' placeholder='Sensor name...' required>
        <input type='text' class='centered' style='display: block;' name='name' placeholder='Channel...' required>
