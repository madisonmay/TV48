    ...
    <script>
        ...
        function co2(percent) {
            ...
            var cloud = "<div class='remove-me' style='display: inline-block; padding: 15px;'>" +
                             "<div class='gray-box' id='gray%count%' style='width: 512px; height: 510px; margin-right: auto; margin-left: auto; background-color: #333333; color: rgb(%red%, %green%, 0); font-size: 40px; padding-bottom: 0px; padding-top: 30px;'>" + 
                             "</div>" +
                             "<div style='text-align: center;'>" + 
                                "<img src='images/person.png' style='margin-right: auto; margin-left: auto; margin-top: -550px;'>" +
                            "</div>" + 
                        "</div>";
